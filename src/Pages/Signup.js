...
async function uploadImage(){
  ...
  data.append('upload_preset', 'mbesteva'); //cloudinary upload preset unsigned token
  try {
    setUploadingImg(true);
    let res= await fetch('https://api.cloudinary.com/v1_1/refresh001/image/upload',{  //cloudinary link using api name
      method: 'POST',
      body: data
    })
